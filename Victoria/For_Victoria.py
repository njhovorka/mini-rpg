...
idle_list = [[pygame.image.load('heavy_idle1.png'), pygame.image.load('heavy_idle1.png'), pygame.image.load('heavy_idle2.png'), pygame.image.load('heavy_idle2.png')] , \
             [pygame.image.load('captain_idle1.png'), pygame.image.load('captain_idle1.png'), pygame.image.load('captain_idle2.png'), pygame.image.load('captain_idle2.png')], \
             [pygame.image.load('engineer_idle1.png'), pygame.image.load('engineer_idle1.png'), pygame.image.load('engineer_idle2.png'), pygame.image.load('engineer_idle2.png')], \
             [pygame.image.load('bot_idle1.png'), pygame.image.load('bot_idle1.png'), pygame.image.load('bot_idle2.png'), pygame.image.load('bot_idle2.png')], \
             [pygame.image.load('rifler_idle1.png'), pygame.image.load('rifler_idle1.png'), pygame.image.load('rifler_idle2.png'), pygame.image.load('rifler_idle2.png')], \
             [pygame.image.load('alchemist_idle1.png'), pygame.image.load('alchemist_idle1.png'), pygame.image.load('alchemist_idle2.png'), pygame.image.load('alchemist_idle2.png')]]
             
firing_list = [[pygame.image.load('heavy_firing1.png'), pygame.image.load('heavy_firing2.png'), pygame.image.load('heavy_firing1.png'), pygame.image.load('heavy_firing2.png')], \
               [pygame.image.load('captain_firing1.png'), pygame.image.load('captain_firing2.png'), pygame.image.load('captain_firing1.png'), pygame.image.load('captain_firing2.png')], \
               [pygame.image.load('engineer_firing1.png'), pygame.image.load('engineer_firing2.png'), pygame.image.load('engineer_firing1.png'), pygame.image.load('engineer_firing2.png')], \
               [pygame.image.load('bot_firing1.png'), pygame.image.load('bot_firing2.png'), pygame.image.load('bot_firing1.png'), pygame.image.load('bot_firing2.png')],\
               [pygame.image.load('rifler_firing1.png'), pygame.image.load('rifler_firing1.png'), pygame.image.load('rifler_firing2.png'), pygame.image.load('rifler_firing1.png')], \
               [pygame.image.load('alchemist_firing1.png'), pygame.image.load('alchemist_firing2.png'), pygame.image.load('alchemist_firing1.png'), pygame.image.load('alchemist_firing2.png')]]
...
fighter_pick = pygame.image.load('fighter_pick.png')
invalid_pic = pygame.image.load('invalid_pic.png')
    ...
    def attack(self, target):
        if self.idle_index == 3:
            ...
            if attacked_person.rifler_buff:
                action_text.append(x.name + ' defends with Rifler Buff ')
                self.hp -= 2
            ...
            if self.engineer_buff and self.idle_index != 2:
                attacked_person.hp -= 2
                self.engineer_buff = False
                action_text.append(x.name + ' attacks with Engineer Buff ')
                    
            if self.idle_index == 4 and self.rifler_buff:
                attacked_person.hp -= 1
                self.rifler_buff = False
                action_text.append(x.name + ' attacks with Rifler Buff ')
            
            if self.captain_buff:
                attacked_person = (fighters[random.randint(0,3)])
                attacked_person.hp -= 1
                action_text.append(x.name + ' attacks with Captain Buff ')
                self.captain_buff = False
...
def drawWindow():
    ...
    if action_delay:
        ...
        for k in action_text:
            text = action_font.render(k , 1, (255,255,255))
            win.blit(text, (180, action_y))
            action_y += 15
...
action_font = pygame.font.SysFont('comicsans', 15, True)
while run:
    ...
    if combat:
        ...
        if delay == 10:
            ...
            if turn_attack:
                for x in fighters:
                    if x.idle_index == 1 and x.captain_buff:

                        x.attack(target_list[0])
                        x.heal(random.randint(1,4))
                        win.blit(action_text,(250,250))
                        x.captain_buff = False
                        action_text.append(x.name + 'uses Captain buff')
                    if x.idle_index != 3 and x.idle_index != 2:
                        x.attack(target_list[0])
                        action_text.append(x.name + ' attacks ' + fighters[target_list[0] + 3].name)
                        if x.idle_index == 0:
                            x.attack(target_list[0])
                    elif x.idle_index == 2 and x.captain_buff:
                        x.attack(target_list[0])
                    elif x.idle_index == 2 and x.engineer_buff:
                        x.attack(1)
                        x.attack(2)
                        x.attack(3)
                        x.attack(4)
                        x.engineer_buff = False
                        action_text.append(x.name + ' uses Engineer Buff ')
            ...
            if turn_heal:
                for x in fighters:
                    if x.idle_index != 0 and x.idle_index != 3:
                        ...
                        action_text.append(x.name + ' heals ' + fighters[target_list[0] - 1].name)
                            
                    elif x.idle_index == 0:
                        x.heal(fighters.index(x) + 1)
                        action_text.append(x.name + ' heals self')
                        if x.hp > 10:
                            x.hp = 10
            ...
            if turn_special:
                for k in fighters:
                    if k.idle_index != 3:
                        ...
                        action_text.append(k.name + ' gives Buff to ' + fighters[target_list[0] - 1].name)
                        if k.alchemist_buff and k.idle_index != 5:
                            valid = False
                            while not valid:
                                index = random.randint(1,4)
                                if index != target_list[0] and (index - 1) !=fighters.index(k):
                                    valid = True
                                    k.special(index)
                                    k.alchemist_buff = False
                                    action_text.append(k.name + ' uses Alchemist Buff on ' + fighters[index - 1].name)
